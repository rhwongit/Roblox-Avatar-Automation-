...
# -----------------------------
# User chooses avatar type to wear
# -----------------------------
...
def wear_outfit(name, data):
    ...
    try:
        ...
        if r.status_code == 200:
            ...
            print(f"Failed to wear {name}: {r.status_code} {r.text}")

    except Exception as e:
        print(f"Error wearing {name}: {e}")

# -----------------------------
# Main loop: random outfit every 10 minutes
# -----------------------------
while True:
